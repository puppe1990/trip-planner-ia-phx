defmodule TripPlannerIa.Climate do
  ...
  @alpine_keywords [
    "suíça", "switzerland", "alp", "neve", "ski", "bariloche", "lap", "islând",
    "noruega", "finlând", "canadá", "alpes", "chamonix", "aspen", "siberia",
    "patagônia", "ushuaia", "himalaia", "alaska", "alasca"
  ]

  @tropical_keywords [
    "rio de janeiro", "copacabana", "bahia", "nordeste", "praia", "beach", "cancún",
    "caribe", "maldivas", "miami", "hawaii", "havaí", "tailândia", "phuket", "bali",
    "ceará", "recife", "salvador", "porto de galinhas", "natal", "jericoacoara",
    "maragogi", "fernando de noronha", "caravelas", "ibiza", "grécia", "santorini",
    "amazon", "manaus", "pantanal"
  ]

  @desert_keywords [
    "egito", "egypt", "cairo", "dubai", "emirados", "saara", "atacama", "arizona",
    "las vegas", "marrocos", "marrakech", "petra", "jordânia", "machu picchu", "lima",
    "texas", "utah", "grand canyon"
  ]

  @southern_hemisphere_keywords [
    "são paulo", "buenos aires", "santiago", "curitiba", "gramado", "porto alegre",
    "florianópolis", "sul", "austrália", "sidney", "melbourne", "áfrica do sul",
    "montevid", "bariloche"
  ]
  ...
  defp northern_temperate_profile do
    %{
      ...
      best_months: "Maio a Junho (temperaturas ótimas) ou Setembro a Outubro (folhagens de outono douradas)",
      months: [
        month("Jan", 6, 1, 60, 3,
